...
public class ExtractFields extends Configured implements Tool {
  public static Log LOG = LogFactory.getLog(ExtractFields.class);
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(ExtractFields.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new ExtractFields(), args);
  }
}
